<div class="circle-menu circle-unselect display-1">
    ...
    <div id="teach" class="cir-menu-item cir-menu-sm-ball bg-success shadow">
        <div class="cir-menu-page" style="width: 100%; height: 100%; overflow: hidden;">
            <div class="icon-wrapper d-flex h-100 w-100 justify-content-center align-items-center">
                <img class="cir-menu-icon w-50 h-50 text-center" src="{{asset('assets/image/panoramic-view.svg')}}" alt="Icon" >
            </div>
            <div class="page">
                @include('component.circle-menu.work')
            </div>
        </div>
    </div>
    ...
    <div id="food" class="cir-menu-item cir-menu-sm-ball bg-success shadow">
        <div class="cir-menu-page" style="width: 100%; height: 100%; overflow: hidden;">
            <div class="icon-wrapper d-flex h-100 w-100 justify-content-center align-items-center">
                <img class="cir-menu-icon w-50 h-50 text-center" src="{{asset('assets/image/panoramic-view.svg')}}" alt="Icon" >
            </div>
